...
def run(args):
    ...
    train_dataset = voc12.dataloader.VOC12AffinityDataset(args.train_list,
                                                          label_dir = os.path.join(args.root_out_dir, args.experiment_ver, args.ir_label_out_dir),
    ...
    for ep in range(args.irn_num_epoches):
        ...
        for iter, pack in enumerate(train_data_loader):
            ...
            timer.reset_stage()
        torch.save(model.module.state_dict(), os.path.join(args.root_out_dir, args.experiment_ver, args.checkpoint_out_dir,f'irn_{ep}_ep19_3025_checkpoint.pth'))
    ...
    torch.save(model.module.state_dict(), os.path.join(args.root_out_dir, args.experiment_ver, args.checkpoint_out_dir, args.irn_weights_name))
